...
class GooglePlaceAutoCompleteTextField extends StatefulWidget {
  ...
  Color? predictionBackgroundColor;
  TextStyle textStyle, predictionTextStyle;
  String googleAPIKey;
  ...
  GooglePlaceAutoCompleteTextField({
    ...
    this.predictionTextStyle = const TextStyle(),
    this.countries,
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return InkWell(
                            ...
                            child: Container(
                              color: widget.predictionBackgroundColor,
                              padding: const EdgeInsets.all(10),
                              child: Text(
                                alPredictions[index].description!,
                                style: widget.predictionTextStyle,
                              ),
                            ),
                          );
                        },
